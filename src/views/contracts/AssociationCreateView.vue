<template>
  <div class="page-container">
    ...
    <div class="form-card">
      <h2 style="color: white; margin-bottom: 2rem;">Register Organization</h2>
...
<style scoped>
.page-container { padding-bottom: 2rem; width: 100%; max-width: 600px; margin: 0 auto; }
...
.form-card { background-color: #161819; padding: 2.5rem; border-radius: 16px; }
.form-group { margin-bottom: 1.5rem; }
.form-group label { display: block; color: var(--emerald-green); margin-bottom: 0.5rem; font-weight: 600;}
